...
ALLOWED={
 ...
 VideoState.READY_FOR_REVIEW:{VideoState.APPROVED,VideoState.REJECTED},
 VideoState.APPROVED:{VideoState.UPLOADED,VideoState.SIMULATED_UPLOAD},
 VideoState.REJECTED:set(),VideoState.UPLOADED:set(),VideoState.SIMULATED_UPLOAD:set(),VideoState.FAILED:set()
}

def can_transition(old:VideoState,new:VideoState)->bool: return new in ALLOWED.get(old,set())
