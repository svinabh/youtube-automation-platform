...
VideoState.READY_FOR_REVIEW:{VideoState.APPROVED,VideoState.REJECTED},VideoState.APPROVED:{VideoState.UPLOADED},
VideoState.REJECTED:set(),VideoState.UPLOADED:set(),VideoState.FAILED:set()}
